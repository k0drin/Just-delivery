...
from api.views import CategoryAPIView, UserAPIView, CategoryItemsListView, AddItemToOrderView, RemoveItemFromOrderView, OrderPreviewView, OrderCheckoutView, UserOrdersListView
